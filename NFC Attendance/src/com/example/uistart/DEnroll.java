...
public class DEnroll extends ParentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.denroll);
		bEnrollOK = (Button) findViewById(R.id.bDEnrollOK);
		bEnrollBack = (Button) findViewById(R.id.bDEnrollBack);
		etEnrollUID = (EditText) findViewById(R.id.etDEnrollUID);
		etEnrollAttendance =(EditText) findViewById(R.id.etDEnrollAttendance);
		spEnrollCourse = (Spinner) findViewById(R.id.spDEnrollCourse);
		...
		bEnrollOK.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(uid.equals("") || course.equals(null)|| uid.equals(null)||
					...
					AlertDialog.Builder builder = new AlertDialog.Builder(DEnroll.this);
						...
						if(flag == 1){
							...
							builder.setNegativeButton("Go to Register",new DialogInterface.OnClickListener() {
										...
										public void onClick(DialogInterface dialog,int which) {
											Intent openReg = new Intent("com.example.uistart.DREGISTERCARD");//parameter is the action name 
							...
							new AsyncTask<String, Void, String>() {
								...
								protected String doInBackground(String... params) {
									regTable = JsonParser.JsonParse(JsonParser.JsonRead("RegistrationD"));
									JsonParser.RegistrationDCreate(uid, course, attendance);
									return null;
								}
							}.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
