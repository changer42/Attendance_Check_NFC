...
public class DCardInfo extends ParentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dcardinfo);
		tvCardInfoUID = (TextView)findViewById(R.id.tvDCardInfoUID);
		tvCardInfoSID = (TextView)findViewById(R.id.tvDCardInfoSID);
		tvCardInfoSName = (TextView)findViewById(R.id.tvDCardInfoSName);
		tvCardInfoCourseCode = (TextView)findViewById(R.id.tvDCardInfoCourseCode);
		tvCardInfoCourseName = (TextView)findViewById(R.id.tvDCardInfoCourseName);
		tvCardInfoCourseAttendance = (TextView)findViewById(R.id.tvDCardInfoCourseAttendance);
...
//						uid = cStudent.getString("uid");
					...
					if(q == 0){
						...
						try {
							...
							tvCardInfoCourseAttendance.setText("Course Quota: "+ JsonParser.findRecordInReg(
						...
						try{
							for(int i = 1; i<=q;i++){
								...
								content = content.append("Course Quota: "+ JsonParser.findRecordInReg(
...
//						setContentView(R.layout.cardinfo);
					...
					tvCardInfoCourseAttendance.setText("Course Quota: ");
				}
