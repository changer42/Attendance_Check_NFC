...
public class NFCMenu extends ListActivity {
	String[] functions ={"CopyOfTakeAttendance", "Enroll", "RegisterCard", "AddCourse",
			"CardInfo", "ShowAttendance", "null"}; 
    @Override
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try {
			...
			Intent myIntent = new Intent(NFCMenu.this, function);
