...
public class DAddCourse extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.daddcourse);
		new HttpRequestUtils();

		bCourseAddConfirm = (Button) findViewById(R.id.bDCourseAddConfirm);
		bCourseAddCancel = (Button) findViewById(R.id.bDCourseAddCancel);
		etCode = (EditText) findViewById(R.id.etDCourseCode);
		etName = (EditText) findViewById(R.id.etDCourseName);
		etRemark = (EditText) findViewById(R.id.etDCourseRemark);
		...
		bCourseAddConfirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(courseCode.equals("")||courseName.equals("")){
					AlertDialog.Builder builder = new AlertDialog.Builder(DAddCourse.this);
...
//						System.out.println("return value: "+courseTable);
						...
						if(courseCode.equals("")){
							...
							flag = false;
							//create this course
							JsonParser.CourseDCreate(courseCode, courseName, remark);
						}
						return flag;
					}
