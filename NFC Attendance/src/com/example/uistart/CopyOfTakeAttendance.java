...
public class CopyOfTakeAttendance extends ParentActivity {
		...
		new AsyncTask<String, Void, String>() {
			...
			protected String doInBackground(String... params) {
				...
				if (courseReged[0].equals("1")) {
					...
					// attendance table
					JsonParser.AttendanceCreate(uid, courseReged[1]);
					JsonParser.increaseAttValue(uid, courseReged[1], regTable);
								...
								public void onClick(DialogInterface dialog,
									...
									new AsyncTask<String, Void, String>() {
										...
										protected String doInBackground(
											...
											String uid = String.valueOf(id);
											JsonParser.AttendanceCreate(uid,
													courseCode);
											JsonParser.increaseAttValue(uid,
													courseCode, regTable);
											counter++;
