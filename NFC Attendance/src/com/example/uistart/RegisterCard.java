...
public class RegisterCard extends ParentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.registercard);
		etRegCardSName = (EditText)findViewById(R.id.etRegCardSName);
		etRegCardSID = (EditText)findViewById(R.id.etRegCardSID);
	...
	protected String dumpTagData(long id) {
		...
		new AsyncTask<String, Void, Boolean>() {
			...
			protected void onPostExecute(Boolean flag) {
				AlertDialog.Builder builder = new AlertDialog.Builder(RegisterCard.this);
				JSONObject cStudent;
							...
							public void onClick(DialogInterface dialog, int which) {
								new AsyncTask<String, Void, String>() {
									...
									protected String doInBackground(String... params) {
										JsonParser.StudentCreate(uid, nSid+"", nSName+"");
										return null;
									}
									@Override
